...
public class PersistenceUtil {
    ...
    public static string LoadDecryptTextFile(string key, string path) {
        string cypherString = LoadTextFile(path);
        if (string.IsNullOrEmpty(cypherString) == true) {
            return "";
        }

        return Service.encryption.Decrypt(key, cypherString);
    }
    ...
    public static bool SaveEncryptTextFile(string path, string key, string text) {
        string cypherString = Service.encryption.Encrypt(key, text);
