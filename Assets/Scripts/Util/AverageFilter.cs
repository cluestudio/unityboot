...
public class AverageFilterVector3 {
    ...
    public Vector3 value { get { return avg; } }
    public int count { get; private set; }
     
    // public apis
    //-------------------------------------------------------------------------
    public AverageFilterVector3(int size = 60) { 
        ready = false;
        SetSize(size);
    }
    ...
    public Vector3 Filter(Vector3 value) {
        ...
        count = Mathf.Min(count+1, filterSize);
        return avg;
    }

    void SetSize(int size) {
        filterSize = Mathf.Max(1, size);
    }
}
...
public class AverageFilterFloat {
    ...
    //-------------------------------------------------------------------------
    public bool ready { get; private set; }
    public float value { get { return avg; } }
    public int count { get; private set; }
